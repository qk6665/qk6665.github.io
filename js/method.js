$.extend({
        ...
        return {
            ...
            actived: function (top) {
                ...
                if (top < titles.eq(0).offset().top) {
                    toc.find("li.active").removeClass("active");
                    var active = toc
                        .find('a[href="#' + titles.eq(0).attr("id") + '"]')
                        .parent();
    ...
    fixedHeader: function (top) {
        var header = $("#header");
        var targetHeight =
            $(".content-header").outerHeight() - header.outerHeight();
        if (top > targetHeight) {
    ...
    reward: function () {
        ...
        if (rewardToggle.length != 0) {
            rewardToggle.change(function () {
                rewardCode.attr(
                    "src",
                    this.checked ? this.dataset.alipay : this.dataset.wechat
                );
            });
        }
    },
